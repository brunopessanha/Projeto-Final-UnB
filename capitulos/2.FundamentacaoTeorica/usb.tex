...
\begin{itemize}
	\item Audio
	\item Comunicação
	\item Interface Humana (HID): destina-se primordialmente aos dispositivos que são usados por humanos para controlar e operacionalizar quaisquer tipos de sistemas computacionais~\cite{hid}. Mais específicamente, possui as seguintes particularidades:
	\begin{itemize}
	...
	\item Segurançà de Conteúdo
	\item Vídeo
	\item Saúde Pessoal
	\item Diagnóstico
	\item Controlador Wireless
	\item Diversos
	\item Aplicação Específica
	\item Fabricante Específico
\end{itemize}
