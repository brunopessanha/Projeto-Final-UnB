...
A seguir, será apresentada a classificação de recursos proposta (seção ~\ref{sec:Aclassficacao}), o conceito de equivalência de recursos (seção ~\ref{sec:Aclassficacao}) e, por fim, o impacto que esta classificação trará para o middleware \emph{uOS} (seção \ref{sec:impactoUOS.
