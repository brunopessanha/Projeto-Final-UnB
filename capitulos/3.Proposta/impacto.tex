...
Esta classificação de recursos impacta na arquitetura original da DSOA de modo que a interface dos recurso, antes contendo apenas seu identificador e serviços, agora deve ter indícios de suas equivalências. Álém disto, modificações na arquitetura impactam nos protocolos uP e no middleware uOS a fim de que estes permaneçam adequados a mesma.
