...
Ambientes de computação ubíqua são compostos por elementos que proveem capacidades (tirar uma foto, medir a temperatura, etc). Um importante desafio para tais ambientes é o desenvolvimento de técnicas de descoberta desses elementos que permitam que aplicativos clientes localizem essas capacidades e dispositivos. Tais técnicas devem atingir três objetivos principais~\cite{balazinska2002ins/twine}:
