...
\begin{itemize}
	\item Arquivo descritor~\cite{}: arquivo estruturado, geralmente binário, onde cada \emph{byte} ou \emph{bit} representa uma informação que pode representar a tipagem ou o valor do dado ou, ainda, um estado, dependendo da sua definição;
