...
\begin{itemize}
	...
	O USB oferece uma capacidade de processamento muito maior que a porta serial e é comparável em velocidade à porta paralela.
	...
	Exemplos de tais dispositivos incluem: \emph{webcams}, filmadoras digitais, conversores analógicos de vídeo, sintonizadores de televisão analógica e digital e imagens de câmeras que suportam \emph{streaming} de vídeo.
	...
	Exemplos de tais dispositivos incluem: medidores de glicose e oxímetros de pulso.
	\item \emph{Diagnostic Device}:

	Destina-se aos dispositivos que diagnosticam outros dispositivos.
	\item \emph{Wireless Controller}: 

	Destina-se aos dispositivos controladores \emph{wireless}.
