...
Há ainda as classes não-IEEE 1451.1, que não estão representadas na hierarquia acima e possuem restrições de aplicabilidade na arquitetura IEEE 1451. Este padrão possui a limitação de ter sido criado para sensores e atuadores, e, portanto, embora possua um relacionamento entre as classes, elas não podem ser extendidas. Como forma de representação, esse padrão utiliza a \emph{Interface Description Language} (IDL).
